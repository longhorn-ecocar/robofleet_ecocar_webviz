 ...
 */
__init(i:number, bb:flatbuffers.ByteBuffer):SensorStatus {
  this.bb_pos = i;
  this.bb = bb;
  return this;
};
...
/**
 * @param flatbuffers.ByteBuffer bb
 * @param SensorStatus= obj
 * @returns SensorStatus
 */
static getRootAsSensorStatus(bb:flatbuffers.ByteBuffer, obj?:SensorStatus):SensorStatus {
  return (obj || new SensorStatus()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
 ...
 * @returns SensorStatus
 */
static getSizePrefixedRootAsSensorStatus(bb:flatbuffers.ByteBuffer, obj?:SensorStatus):SensorStatus {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new SensorStatus()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
 ...
 * @returns ColoredText
 */
__init(i:number, bb:flatbuffers.ByteBuffer):ColoredText {
  this.bb_pos = i;
  this.bb = bb;
  return this;
};
...
/**
 * @param flatbuffers.ByteBuffer bb
 * @param ColoredText= obj
 * @returns ColoredText
 */
static getRootAsColoredText(bb:flatbuffers.ByteBuffer, obj?:ColoredText):ColoredText {
  return (obj || new ColoredText()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
 ...
 * @returns ColoredText
 */
static getSizePrefixedRootAsColoredText(bb:flatbuffers.ByteBuffer, obj?:ColoredText):ColoredText {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new ColoredText()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
 ...
 * @returns fb.amrl_msgs.Point2D|null
 */
start(obj?:fb.amrl_msgs.Point2D):fb.amrl_msgs.Point2D|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new fb.amrl_msgs.Point2D()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};
 ...
 * @param flatbuffers.Builder builder
 */
static startColoredText(builder:flatbuffers.Builder) {
  builder.startObject(5);
};
 ...
 * @param number sizeEm
 */
static addSizeEm(builder:flatbuffers.Builder, sizeEm:number) {
  builder.addFieldFloat32(3, sizeEm, 0.0);
};
 ...
 * @returns flatbuffers.Offset
 */
static endColoredText(builder:flatbuffers.Builder):flatbuffers.Offset {
  var offset = builder.endObject();
...
/**
 * @param number index
 * @param fb.amrl_msgs.ColoredText= obj
 * @returns fb.amrl_msgs.ColoredText
 */
textAnnotations(index: number, obj?:fb.amrl_msgs.ColoredText):fb.amrl_msgs.ColoredText|null {
  var offset = this.bb!.__offset(this.bb_pos, 20);
  return offset ? (obj || new fb.amrl_msgs.ColoredText()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};

/**
 * @returns number
 */
textAnnotationsLength():number {
  var offset = this.bb!.__offset(this.bb_pos, 20);
  return offset ? this.bb!.__vector_len(this.bb_pos + offset) : 0;
};
...
/**
 * @param flatbuffers.Builder builder
 * @param flatbuffers.Offset textAnnotationsOffset
 */
static addTextAnnotations(builder:flatbuffers.Builder, textAnnotationsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(8, textAnnotationsOffset, 0);
};
 ...
 * @returns flatbuffers.Offset
 */
static createTextAnnotationsVector(builder:flatbuffers.Builder, data:flatbuffers.Offset[]):flatbuffers.Offset {
  builder.startVector(4, data.length, 4);
  for (var i = data.length - 1; i >= 0; i--) {
    builder.addOffset(data[i]);
  }
 ...
 * @param number numElems
 */
static startTextAnnotationsVector(builder:flatbuffers.Builder, numElems:number) {
  builder.startVector(4, numElems, 4);
};
...
static endVisualizationMsg(builder:flatbuffers.Builder):flatbuffers.Offset {
  ...
  builder.requiredField(offset, 20); // text_annotations
  return offset;
};
